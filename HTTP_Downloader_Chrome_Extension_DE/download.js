...
function SendDownloadToClient()
{
	...
	if ( request )
	{
		...
		request.onerror = function( e )
		{
			...
			window.alert( "Beim senden der Anfrage für den Download ist ein Fehler aufgetreten." );
		};
		...
		request.ontimeout = function( e )
		{
			...
			window.alert( "Die Zeit für den Aufbau der Verbindung wurde überschritten." );
		};
		...
		request.onload = function( e )
		{
			...
			else
			{
				...
				window.alert( "Der Server hat mit einer ungültiger Antwort auf die Anfrage geantwortet." );
			}
		};
