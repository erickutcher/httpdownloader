...
#define BTN_DOWNLOAD_NON_200_206	1005
#define BTN_USE_ONE_INSTANCE		1006
#define BTN_PREVENT_STANDBY			1007
#define BTN_RESUME_DOWNLOADS		1008
#define BTN_MOVE_TO_TRASH			1009
#define BTN_OVERRIDE_LIST_PROMPTS	1010

#define CB_DRAG_AND_DROP_ACTION		1011

#define CB_PROMPT_LAST_MODIFIED		1012
#define CB_PROMPT_RENAME			1013
#define CB_PROMPT_FILE_SIZE			1014
#define EDIT_MAX_FILE_SIZE			1015

#define CB_SHUTDOWN_ACTION			1016

#define BTN_DEFAULT_DOWNLOAD_DIRECTORY	1017

#define BTN_USE_TEMP_DOWNLOAD_DIRECTORY	1018
#define BTN_TEMP_DOWNLOAD_DIRECTORY		1019

#define EDIT_THREAD_COUNT			1020
...
LRESULT CALLBACK AdvancedTabWndProc( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
	switch ( msg )
	{
		case WM_CREATE:
		{
			...
			g_hWnd_chk_sparse_file_allocation = _CreateWindowW( WC_BUTTON, ST_V_Enable_sparse_file_allocation, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 40, rc.right - 10, 20, hWnd, ( HMENU )BTN_SPARSE_FILE_ALLOCATION, NULL, NULL );
			g_hWnd_chk_set_filetime = _CreateWindowW( WC_BUTTON, ST_V_Set_date_and_time_of_file, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 60, rc.right - 10, 20, hWnd, ( HMENU )BTN_SET_FILETIME, NULL, NULL );
			g_hWnd_chk_update_redirected = _CreateWindowW( WC_BUTTON, ST_V_Update_redirected_URL_s__in_download_list, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 80, rc.right - 10, 20, hWnd, ( HMENU )BTN_UPDATE_REDIRECTED, NULL, NULL );
			g_hWnd_chk_download_non_200_206 = _CreateWindowW( WC_BUTTON, ST_V_Download_non_200_and_non_206_responses, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 100, rc.right - 10, 20, hWnd, ( HMENU )BTN_DOWNLOAD_NON_200_206, NULL, NULL );
			g_hWnd_chk_use_one_instance = _CreateWindowW( WC_BUTTON, ST_V_Allow_only_one_instance, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 120, rc.right - 10, 20, hWnd, ( HMENU )BTN_USE_ONE_INSTANCE, NULL, NULL );
			g_hWnd_chk_prevent_standby = _CreateWindowW( WC_BUTTON, ST_V_Prevent_system_standby, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 140, rc.right - 10, 20, hWnd, ( HMENU )BTN_PREVENT_STANDBY, NULL, NULL );
			g_hWnd_chk_resume_downloads = _CreateWindowW( WC_BUTTON, ST_V_Resume_previously_downloading, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 160, rc.right - 10, 20, hWnd, ( HMENU )BTN_RESUME_DOWNLOADS, NULL, NULL );
			g_hWnd_chk_move_to_trash = _CreateWindowW( WC_BUTTON, ST_V_Move_deleted_downloads_to_Recycle_Bin, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 180, rc.right - 10, 20, hWnd, ( HMENU )BTN_MOVE_TO_TRASH, NULL, NULL );
			g_hWnd_chk_override_list_prompts = _CreateWindowW( WC_BUTTON, ST_V_Override_download_list_action_prompts, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 200, rc.right - 10, 20, hWnd, ( HMENU )BTN_OVERRIDE_LIST_PROMPTS, NULL, NULL );

			/*HWND hWnd_static_hoz1 =*/ _CreateWindowW( WC_STATIC, NULL, SS_ETCHEDHORZ | WS_CHILD | WS_VISIBLE, 0, 226, rc.right - 10, 1, hWnd, NULL, NULL, NULL );

			HWND hWnd_static_drag_and_drop_action = _CreateWindowW( WC_STATIC, ST_V_Drag_and_drop_URL_s__action_, WS_CHILD | WS_VISIBLE, 0, 241, rc.right - 165, 15, hWnd, NULL, NULL, NULL );
			g_hWnd_drag_and_drop_action = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_COMBOBOX, NULL, CBS_AUTOHSCROLL | CBS_DROPDOWNLIST | WS_CHILD | WS_TABSTOP | WS_VSCROLL | WS_VISIBLE | CBS_DARK_MODE, rc.right - 160, 237, 150, 23, hWnd, ( HMENU )CB_DRAG_AND_DROP_ACTION, NULL, NULL );
			...
			HWND hWnd_static_prompt_last_modified = _CreateWindowW( WC_STATIC, ST_V_When_a_file_has_been_modified_, WS_CHILD | WS_VISIBLE, 0, 269, rc.right - 165, 15, hWnd, NULL, NULL, NULL );
			g_hWnd_prompt_last_modified = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_COMBOBOX, NULL, CBS_AUTOHSCROLL | CBS_DROPDOWNLIST | WS_CHILD | WS_TABSTOP | WS_VSCROLL | WS_VISIBLE | CBS_DARK_MODE, rc.right - 160, 265, 150, 23, hWnd, ( HMENU )CB_PROMPT_LAST_MODIFIED, NULL, NULL );
			...
			HWND hWnd_static_prompt_rename = _CreateWindowW( WC_STATIC, ST_V_When_a_file_already_exists_, WS_CHILD | WS_VISIBLE, 0, 297, rc.right - 165, 15, hWnd, NULL, NULL, NULL );
			g_hWnd_prompt_rename = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_COMBOBOX, NULL, CBS_AUTOHSCROLL | CBS_DROPDOWNLIST | WS_CHILD | WS_TABSTOP | WS_VSCROLL | WS_VISIBLE | CBS_DARK_MODE, rc.right - 160, 293, 150, 23, hWnd, ( HMENU )CB_PROMPT_RENAME, NULL, NULL );
			...
			HWND hWnd_static_prompt_file_size = _CreateWindowW( WC_STATIC, ST_V_When_a_file_is_greater_than_or_equal_to_, WS_CHILD | WS_VISIBLE, 0, 325, rc.right - 270, 15, hWnd, NULL, NULL, NULL );

			g_hWnd_max_file_size = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_EDIT, NULL, ES_AUTOHSCROLL | ES_CENTER | ES_NUMBER | WS_CHILD | WS_TABSTOP | WS_VISIBLE, rc.right - 265, 321, 100, 23, hWnd, ( HMENU )EDIT_MAX_FILE_SIZE, NULL, NULL );
			...
			g_hWnd_prompt_file_size = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_COMBOBOX, NULL, CBS_AUTOHSCROLL | CBS_DROPDOWNLIST | WS_CHILD | WS_TABSTOP | WS_VSCROLL | WS_VISIBLE | CBS_DARK_MODE, rc.right - 160, 321, 150, 23, hWnd, ( HMENU )CB_PROMPT_FILE_SIZE, NULL, NULL );
			...
			HWND hWnd_static_shutdown_action = _CreateWindowW( WC_STATIC, ST_V_System_shutdown_action_, WS_CHILD | WS_VISIBLE, 0, 353, rc.right - 165, 15, hWnd, NULL, NULL, NULL );
			g_hWnd_shutdown_action = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_COMBOBOX, NULL, CBS_AUTOHSCROLL | CBS_DROPDOWNLIST | WS_CHILD | WS_TABSTOP | WS_VSCROLL | WS_VISIBLE | CBS_DARK_MODE, rc.right - 160, 349, 150, 23, hWnd, ( HMENU )CB_SHUTDOWN_ACTION, NULL, NULL );
			...
			/*HWND hWnd_static_hoz2 =*/ _CreateWindowW( WC_STATIC, NULL, SS_ETCHEDHORZ | WS_CHILD | WS_VISIBLE, 0, 382, rc.right - 10, 1, hWnd, NULL, NULL, NULL );


			HWND hWnd_static_default_download_directory = _CreateWindowW( WC_STATIC, ST_V_Default_download_directory_, WS_CHILD | WS_VISIBLE, 0, 390, rc.right - 10, 15, hWnd, NULL, NULL, NULL );
			g_hWnd_default_download_directory = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_EDIT, cfg_default_download_directory, ES_AUTOHSCROLL | ES_READONLY | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 408, rc.right - 50, 23, hWnd, NULL, NULL, NULL );
			g_hWnd_btn_default_download_directory = _CreateWindowW( WC_BUTTON, ST_V_BTN___, WS_CHILD | WS_TABSTOP | WS_VISIBLE, rc.right - 45, 408, 35, 23, hWnd, ( HMENU )BTN_DEFAULT_DOWNLOAD_DIRECTORY, NULL, NULL );


			g_hWnd_chk_temp_download_directory = _CreateWindowW( WC_BUTTON, ST_V_Use_temporary_download_directory_, BS_AUTOCHECKBOX | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 438, rc.right - 10, 20, hWnd, ( HMENU )BTN_USE_TEMP_DOWNLOAD_DIRECTORY, NULL, NULL );
			g_hWnd_temp_download_directory = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_EDIT, cfg_temp_download_directory, ES_AUTOHSCROLL | ES_READONLY | WS_CHILD | WS_TABSTOP | WS_VISIBLE, 0, 458, rc.right - 50, 23, hWnd, NULL, NULL, NULL );
			g_hWnd_btn_temp_download_directory = _CreateWindowW( WC_BUTTON, ST_V_BTN___, WS_CHILD | WS_TABSTOP | WS_VISIBLE, rc.right - 45, 458, 35, 23, hWnd, ( HMENU )BTN_TEMP_DOWNLOAD_DIRECTORY, NULL, NULL );


			/*HWND hWnd_static_hoz3 =*/ _CreateWindowW( WC_STATIC, NULL, SS_ETCHEDHORZ | WS_CHILD | WS_VISIBLE, 0, 491, rc.right - 10, 1, hWnd, NULL, NULL, NULL );
			...
			g_hWnd_thread_count = _CreateWindowExW( WS_EX_CLIENTEDGE, WC_EDIT, NULL, ES_AUTOHSCROLL | ES_CENTER | ES_NUMBER | WS_CHILD | WS_TABSTOP | WS_VISIBLE, rc.right - 110, 502, 100, 23, hWnd, ( HMENU )EDIT_THREAD_COUNT, NULL, NULL );
			...
			_SetWindowPos( hWnd_static_thread_count, HWND_TOP, 0, 506, rc.right - ( 115 + spinner_width ), 15, SWP_NOZORDER );
			_SetWindowPos( g_hWnd_thread_count, HWND_TOP, rc.right - ( 110 + spinner_width ), 502, 100, 23, SWP_NOZORDER );
			_SetWindowPos( g_hWnd_ud_thread_count, HWND_TOP, rc.right - 10 - spinner_width, 502, 0, 0, SWP_NOZORDER | SWP_NOSIZE );
			...
			si.nMin = 0;
			si.nMax = 525;	// Bottom of the last item in the window.
			...
			_SendMessageW( g_hWnd_chk_sparse_file_allocation, WM_SETFONT, ( WPARAM )g_hFont, 0 );
			...
			_SendMessageW( g_hWnd_chk_override_list_prompts, WM_SETFONT, ( WPARAM )g_hFont, 0 );
