...
#define OPTIONS_PROXY_STRING_TABLE_SIZE			2

#define CMESSAGEBOX_STRING_TABLE_SIZE			7

#define ADD_URLS_STRING_TABLE_SIZE				17
...
// Options Proxy
#define ST_V_Enable_HTTP_proxy_							g_locale_table[ 179 ].value
#define ST_V_Enable_HTTPS_proxy_						g_locale_table[ 180 ].value

// CMessageBox
#define ST_V_Continue									g_locale_table[ 181 ].value
#define ST_V_No											g_locale_table[ 182 ].value
#define ST_V_Overwrite									g_locale_table[ 183 ].value
#define ST_V_Remember_choice							g_locale_table[ 184 ].value
#define ST_V_Skip										g_locale_table[ 185 ].value
#define ST_V_Skip_remaining_messages					g_locale_table[ 186 ].value
#define ST_V_Yes										g_locale_table[ 187 ].value

// Add URL(s)
#define ST_V_Advanced_AB								g_locale_table[ 188 ].value
#define ST_V_Advanced_BB								g_locale_table[ 189 ].value
#define	ST_V_Authentication								g_locale_table[ 190 ].value
#define ST_V_Cookies									g_locale_table[ 191 ].value
#define ST_V_Cookies_									g_locale_table[ 192 ].value
#define ST_V_Download									g_locale_table[ 193 ].value
#define ST_V_Download_directory_						g_locale_table[ 194 ].value
#define ST_V_Download_parts_							g_locale_table[ 195 ].value
#define ST_V_Headers									g_locale_table[ 196 ].value
#define ST_V_Headers_									g_locale_table[ 197 ].value
#define ST_V_Password_									g_locale_table[ 198 ].value
#define ST_V_POST_Data									g_locale_table[ 199 ].value
#define ST_V_Send_POST_Data_							g_locale_table[ 200 ].value
#define ST_V_Simulate_download							g_locale_table[ 201 ].value
#define ST_V_SSL___TLS_version_							g_locale_table[ 202 ].value
#define ST_V_URL_s__									g_locale_table[ 203 ].value
#define ST_V_Username_									g_locale_table[ 204 ].value

// Search
#define ST_V_Match_case									g_locale_table[ 205 ].value
#define ST_V_Match_whole_word							g_locale_table[ 206 ].value
#define ST_V_Search										g_locale_table[ 207 ].value
#define ST_V_Search_All									g_locale_table[ 208 ].value
#define ST_V_Search_for_								g_locale_table[ 209 ].value
#define ST_V_Search_Next								g_locale_table[ 210 ].value
#define ST_V_Search_Type								g_locale_table[ 211 ].value

// Common
#define ST_V_BTN___										g_locale_table[ 212 ].value
#define ST_V__Simulated_								g_locale_table[ 213 ].value
#define ST_V_Add_URL_s_									g_locale_table[ 214 ].value
#define ST_V_Added										g_locale_table[ 215 ].value
#define ST_V_Allocating_File							g_locale_table[ 216 ].value
#define ST_V_Authorization_Required						g_locale_table[ 217 ].value
#define ST_V_Cancel										g_locale_table[ 218 ].value
#define ST_V_Completed									g_locale_table[ 219 ].value
#define ST_V_Connecting									g_locale_table[ 220 ].value
#define ST_V_Download_speed_							g_locale_table[ 221 ].value
#define ST_V_Download_speed__0_B_s						g_locale_table[ 222 ].value
#define ST_V_Download_speed__0_00_GB_s					g_locale_table[ 223 ].value
#define ST_V_Download_speed__0_00_KB_s					g_locale_table[ 224 ].value
#define ST_V_Download_speed__0_00_MB_s					g_locale_table[ 225 ].value
#define ST_V_Downloading								g_locale_table[ 226 ].value
#define ST_V_Downloads_Have_Finished					g_locale_table[ 227 ].value
#define ST_V_Export_Download_History					g_locale_table[ 228 ].value
#define ST_V_Failed										g_locale_table[ 229 ].value
#define ST_V_File_IO_Error								g_locale_table[ 230 ].value
#define ST_V_Import_Download_History					g_locale_table[ 231 ].value
#define ST_V_Moving_File								g_locale_table[ 232 ].value
#define ST_V_Options									g_locale_table[ 233 ].value
#define ST_V_Paused										g_locale_table[ 234 ].value
#define ST_V_Proxy_Authentication_Required				g_locale_table[ 235 ].value
#define ST_V_Queued										g_locale_table[ 236 ].value
#define ST_V_Restarting									g_locale_table[ 237 ].value
#define ST_V_Save_Download_History						g_locale_table[ 238 ].value
#define ST_V_Skipped									g_locale_table[ 239 ].value
#define ST_V_Stopped									g_locale_table[ 240 ].value
#define ST_V_SSL_2_0									g_locale_table[ 241 ].value
#define ST_V_SSL_3_0									g_locale_table[ 242 ].value
#define ST_V_Timed_Out									g_locale_table[ 243 ].value
#define ST_V_TLS_1_0									g_locale_table[ 244 ].value
#define ST_V_TLS_1_1									g_locale_table[ 245 ].value
#define ST_V_TLS_1_2									g_locale_table[ 246 ].value
#define ST_V_Total_downloaded_							g_locale_table[ 247 ].value
#define ST_V_Total_downloaded__0_B						g_locale_table[ 248 ].value
#define ST_V_Total_downloaded__0_00_GB					g_locale_table[ 249 ].value
#define ST_V_Total_downloaded__0_00_KB					g_locale_table[ 250 ].value
#define ST_V_Total_downloaded__0_00_MB					g_locale_table[ 251 ].value
#define ST_V_URL_										g_locale_table[ 252 ].value
#define ST_V_Update										g_locale_table[ 253 ].value
#define ST_V_Update_Download							g_locale_table[ 254 ].value

// Common Messages
#define ST_V_A_restart_is_required						g_locale_table[ 255 ].value
#define ST_V_A_restart_is_required_allocation			g_locale_table[ 256 ].value
#define ST_V_A_restart_is_required_threads				g_locale_table[ 257 ].value
#define ST_V_PROMPT_delete_selected_files				g_locale_table[ 258 ].value
#define ST_V_PROMPT_remove_completed_entries			g_locale_table[ 259 ].value
#define ST_V_PROMPT_remove_and_delete_selected_entries	g_locale_table[ 260 ].value
#define ST_V_PROMPT_remove_selected_entries				g_locale_table[ 261 ].value
#define ST_V_PROMPT_restart_selected_entries			g_locale_table[ 262 ].value
#define ST_V_One_or_more_files_are_in_use				g_locale_table[ 263 ].value
#define ST_V_One_or_more_files_were_not_found			g_locale_table[ 264 ].value
#define ST_V_Select_the_default_download_directory		g_locale_table[ 265 ].value
#define ST_V_Select_the_download_directory				g_locale_table[ 266 ].value
#define ST_V_Select_the_temporary_download_directory	g_locale_table[ 267 ].value
#define ST_V_The_download_will_be_resumed				g_locale_table[ 268 ].value
#define ST_V_File_is_in_use_cannot_delete				g_locale_table[ 269 ].value
#define ST_V_File_is_in_use_cannot_rename				g_locale_table[ 270 ].value
#define ST_V_File_format_is_incorrect					g_locale_table[ 271 ].value
#define ST_V_PROMPT_The_specified_file_was_not_found	g_locale_table[ 272 ].value
#define ST_V_The_specified_path_was_not_found			g_locale_table[ 273 ].value
#define ST_V_There_is_already_a_file					g_locale_table[ 274 ].value
#define ST_V_You_must_supply_download_directory			g_locale_table[ 275 ].value
...
// Options Proxy
#define ST_L_Enable_HTTP_proxy_							g_locale_table[ 179 ].length
#define ST_L_Enable_HTTPS_proxy_						g_locale_table[ 180 ].length

// CMessageBox
#define ST_L_Continue									g_locale_table[ 181 ].length
#define ST_L_No											g_locale_table[ 182 ].length
#define ST_L_Overwrite									g_locale_table[ 183 ].length
#define ST_L_Remember_choice							g_locale_table[ 184 ].length
#define ST_L_Skip										g_locale_table[ 185 ].length
#define ST_L_Skip_remaining_messages					g_locale_table[ 186 ].length
#define ST_L_Yes										g_locale_table[ 187 ].length

// Add URL(s)
#define ST_L_Advanced_AB								g_locale_table[ 188 ].length
#define ST_L_Advanced_BB								g_locale_table[ 189 ].length
#define	ST_L_Authentication								g_locale_table[ 190 ].length
#define ST_L_Cookies									g_locale_table[ 191 ].length
#define ST_L_Cookies_									g_locale_table[ 192 ].length
#define ST_L_Download									g_locale_table[ 193 ].length
#define ST_L_Download_directory_						g_locale_table[ 194 ].length
#define ST_L_Download_parts_							g_locale_table[ 195 ].length
#define ST_L_Headers									g_locale_table[ 196 ].length
#define ST_L_Headers_									g_locale_table[ 197 ].length
#define ST_L_Password_									g_locale_table[ 198 ].length
#define ST_L_POST_Data									g_locale_table[ 199 ].length
#define ST_L_Send_POST_Data_							g_locale_table[ 200 ].length
#define ST_L_Simulate_download							g_locale_table[ 201 ].length
#define ST_L_SSL___TLS_version_							g_locale_table[ 202 ].length
#define ST_L_URL_s__									g_locale_table[ 203 ].length
#define ST_L_Username_									g_locale_table[ 204 ].length

// Search
#define ST_L_Match_case									g_locale_table[ 205 ].length
#define ST_L_Match_whole_word							g_locale_table[ 206 ].length
#define ST_L_Search										g_locale_table[ 207 ].length
#define ST_L_Search_All									g_locale_table[ 208 ].length
#define ST_L_Search_for_								g_locale_table[ 209 ].length
#define ST_L_Search_Next								g_locale_table[ 210 ].length
#define ST_L_Search_Type								g_locale_table[ 211 ].length

// Common
#define ST_L_BTN___										g_locale_table[ 212 ].length
#define ST_L__Simulated_								g_locale_table[ 213 ].length
#define ST_L_Add_URL_s_									g_locale_table[ 214 ].length
#define ST_L_Added										g_locale_table[ 215 ].length
#define ST_L_Allocating_File							g_locale_table[ 216 ].length
#define ST_L_Authorization_Required						g_locale_table[ 217 ].length
#define ST_L_Cancel										g_locale_table[ 218 ].length
#define ST_L_Completed									g_locale_table[ 219 ].length
#define ST_L_Connecting									g_locale_table[ 220 ].length
#define ST_L_Download_speed_							g_locale_table[ 221 ].length
#define ST_L_Download_speed__0_B_s						g_locale_table[ 222 ].length
#define ST_L_Download_speed__0_00_GB_s					g_locale_table[ 223 ].length
#define ST_L_Download_speed__0_00_KB_s					g_locale_table[ 224 ].length
#define ST_L_Download_speed__0_00_MB_s					g_locale_table[ 225 ].length
#define ST_L_Downloading								g_locale_table[ 226 ].length
#define ST_L_Downloads_Have_Finished					g_locale_table[ 227 ].length
#define ST_L_Export_Download_History					g_locale_table[ 228 ].length
#define ST_L_Failed										g_locale_table[ 229 ].length
#define ST_L_File_IO_Error								g_locale_table[ 230 ].length
#define ST_L_Import_Download_History					g_locale_table[ 231 ].length
#define ST_L_Moving_File								g_locale_table[ 232 ].length
#define ST_L_Options									g_locale_table[ 233 ].length
#define ST_L_Paused										g_locale_table[ 234 ].length
#define ST_L_Proxy_Authentication_Required				g_locale_table[ 235 ].length
#define ST_L_Queued										g_locale_table[ 236 ].length
#define ST_L_Restarting									g_locale_table[ 237 ].length
#define ST_L_Save_Download_History						g_locale_table[ 238 ].length
#define ST_L_Skipped									g_locale_table[ 239 ].length
#define ST_L_Stopped									g_locale_table[ 240 ].length
#define ST_L_SSL_2_0									g_locale_table[ 241 ].length
#define ST_L_SSL_3_0									g_locale_table[ 242 ].length
#define ST_L_Timed_Out									g_locale_table[ 243 ].length
#define ST_L_TLS_1_0									g_locale_table[ 244 ].length
#define ST_L_TLS_1_1									g_locale_table[ 245 ].length
#define ST_L_TLS_1_2									g_locale_table[ 246 ].length
#define ST_L_Total_downloaded_							g_locale_table[ 247 ].length
#define ST_L_Total_downloaded__0_B						g_locale_table[ 248 ].length
#define ST_L_Total_downloaded__0_00_GB					g_locale_table[ 249 ].length
#define ST_L_Total_downloaded__0_00_KB					g_locale_table[ 250 ].length
#define ST_L_Total_downloaded__0_00_MB					g_locale_table[ 251 ].length
#define ST_L_URL_										g_locale_table[ 252 ].length
#define ST_L_Update										g_locale_table[ 253 ].length
#define ST_L_Update_Download							g_locale_table[ 254 ].length

// Common Messages
#define ST_L_A_restart_is_required						g_locale_table[ 255 ].length
#define ST_L_A_restart_is_required_allocation			g_locale_table[ 256 ].length
#define ST_L_A_restart_is_required_threads				g_locale_table[ 257 ].length
#define ST_L_PROMPT_delete_selected_files				g_locale_table[ 258 ].length
#define ST_L_PROMPT_remove_completed_entries			g_locale_table[ 259 ].length
#define ST_L_PROMPT_remove_and_delete_selected_entries	g_locale_table[ 260 ].length
#define ST_L_PROMPT_remove_selected_entries				g_locale_table[ 261 ].length
#define ST_L_PROMPT_restart_selected_entries			g_locale_table[ 262 ].length
#define ST_L_One_or_more_files_are_in_use				g_locale_table[ 263 ].length
#define ST_L_One_or_more_files_were_not_found			g_locale_table[ 264 ].length
#define ST_L_Select_the_default_download_directory		g_locale_table[ 265 ].length
#define ST_L_Select_the_download_directory				g_locale_table[ 266 ].length
#define ST_L_Select_the_temporary_download_directory	g_locale_table[ 267 ].length
#define ST_L_The_download_will_be_resumed				g_locale_table[ 268 ].length
#define ST_L_File_is_in_use_cannot_delete				g_locale_table[ 269 ].length
#define ST_L_File_is_in_use_cannot_rename				g_locale_table[ 270 ].length
#define ST_L_File_format_is_incorrect					g_locale_table[ 271 ].length
#define ST_L_PROMPT_The_specified_file_was_not_found	g_locale_table[ 272 ].length
#define ST_L_The_specified_path_was_not_found			g_locale_table[ 273 ].length
#define ST_L_There_is_already_a_file					g_locale_table[ 274 ].length
#define ST_L_You_must_supply_download_directory			g_locale_table[ 275 ].length
