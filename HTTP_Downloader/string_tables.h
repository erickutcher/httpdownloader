...
#define OPTIONS_STRING_TABLE_SIZE			49
...
#define ST_V_Proxy										g_locale_table[ 137 ].value
#define ST_V_Public___Private_key_pair_					g_locale_table[ 138 ].value
#define ST_V_Require_authentication_					g_locale_table[ 139 ].value
#define ST_V_Retry_incomplete_downloads_				g_locale_table[ 140 ].value
#define ST_V_Retry_incomplete_parts_					g_locale_table[ 141 ].value
#define ST_V_Server_SSL___TLS_version_					g_locale_table[ 142 ].value
#define ST_V_Set_date_and_time_of_file					g_locale_table[ 143 ].value
#define ST_V_Show_notification_when_downloads_finish	g_locale_table[ 144 ].value
#define ST_V_Thread_pool_count_							g_locale_table[ 145 ].value
#define ST_V_Timeout__seconds__							g_locale_table[ 146 ].value

// Add URL(s)
#define ST_V_Advanced_AB								g_locale_table[ 147 ].value
#define ST_V_Advanced_BB								g_locale_table[ 148 ].value
#define	ST_V_Authentication								g_locale_table[ 149 ].value
#define ST_V_Cookies_									g_locale_table[ 150 ].value
#define ST_V_Download									g_locale_table[ 151 ].value
#define ST_V_Download_directory_						g_locale_table[ 152 ].value
#define ST_V_Download_parts_							g_locale_table[ 153 ].value
#define ST_V_Headers_									g_locale_table[ 154 ].value
#define ST_V_Password_									g_locale_table[ 155 ].value
#define ST_V_Send_POST_Data_							g_locale_table[ 156 ].value
#define ST_V_Simulate_download							g_locale_table[ 157 ].value
#define ST_V_SSL___TLS_version_							g_locale_table[ 158 ].value
#define ST_V_URL_s__									g_locale_table[ 159 ].value
#define ST_V_Username_									g_locale_table[ 160 ].value

// Search
#define ST_V_Match_case									g_locale_table[ 161 ].value
#define ST_V_Match_whole_word							g_locale_table[ 162 ].value
#define ST_V_Search										g_locale_table[ 163 ].value
#define ST_V_Search_All									g_locale_table[ 164 ].value
#define ST_V_Search_for_								g_locale_table[ 165 ].value
#define ST_V_Search_Next								g_locale_table[ 166 ].value
#define ST_V_Search_Type								g_locale_table[ 167 ].value

// Common
#define ST_V_BTN___										g_locale_table[ 168 ].value
#define ST_V__Simulated_								g_locale_table[ 169 ].value
#define ST_V_Add_URL_s_									g_locale_table[ 170 ].value
#define ST_V_Added										g_locale_table[ 171 ].value
#define ST_V_All_downloads_have_finished_				g_locale_table[ 172 ].value
...
#define ST_V_Export_Download_History					g_locale_table[ 183 ].value
#define ST_V_Failed										g_locale_table[ 184 ].value
#define ST_V_File_IO_Error								g_locale_table[ 185 ].value
#define ST_V_Import_Download_History					g_locale_table[ 186 ].value
#define ST_V_Options									g_locale_table[ 187 ].value
#define ST_V_Paused										g_locale_table[ 188 ].value
#define ST_V_Proxy_Authentication_Required				g_locale_table[ 189 ].value
#define ST_V_Queued										g_locale_table[ 190 ].value
#define ST_V_Restarting									g_locale_table[ 191 ].value
#define ST_V_Save_Download_History						g_locale_table[ 192 ].value
#define ST_V_Skipped									g_locale_table[ 193 ].value
#define ST_V_Stopped									g_locale_table[ 194 ].value
#define ST_V_SSL_2_0									g_locale_table[ 195 ].value
#define ST_V_SSL_3_0									g_locale_table[ 196 ].value
#define ST_V_Timed_Out									g_locale_table[ 197 ].value
#define ST_V_TLS_1_0									g_locale_table[ 198 ].value
#define ST_V_TLS_1_1									g_locale_table[ 199 ].value
#define ST_V_TLS_1_2									g_locale_table[ 200 ].value
#define ST_V_Total_downloaded_							g_locale_table[ 201 ].value
#define ST_V_Total_downloaded__0_B						g_locale_table[ 202 ].value
#define ST_V_Total_downloaded__0_00_GB					g_locale_table[ 203 ].value
#define ST_V_Total_downloaded__0_00_KB					g_locale_table[ 204 ].value
#define ST_V_Total_downloaded__0_00_MB					g_locale_table[ 205 ].value
#define ST_V_URL_										g_locale_table[ 206 ].value
#define ST_V_Update										g_locale_table[ 207 ].value
#define ST_V_Update_Download							g_locale_table[ 208 ].value

// Common Messages
#define ST_V_A_restart_is_required						g_locale_table[ 209 ].value
#define ST_V_A_restart_is_required_allocation			g_locale_table[ 210 ].value
#define ST_V_A_restart_is_required_threads				g_locale_table[ 211 ].value
#define ST_V_PROMPT_delete_selected_files				g_locale_table[ 212 ].value
#define ST_V_PROMPT_remove_completed_entries			g_locale_table[ 213 ].value
#define ST_V_PROMPT_remove_and_delete_selected_entries	g_locale_table[ 214 ].value
#define ST_V_PROMPT_remove_selected_entries				g_locale_table[ 215 ].value
#define ST_V_PROMPT_restart_selected_entries			g_locale_table[ 216 ].value
#define ST_V_One_or_more_files_are_in_use				g_locale_table[ 217 ].value
#define ST_V_One_or_more_files_were_not_found			g_locale_table[ 218 ].value
#define ST_V_Select_the_default_download_directory		g_locale_table[ 219 ].value
#define ST_V_Select_the_download_directory				g_locale_table[ 220 ].value
#define ST_V_The_download_will_be_resumed				g_locale_table[ 221 ].value
#define ST_V_File_is_in_use_cannot_delete				g_locale_table[ 222 ].value
#define ST_V_File_is_in_use_cannot_rename				g_locale_table[ 223 ].value
#define ST_V_File_format_is_incorrect					g_locale_table[ 224 ].value
#define ST_V_PROMPT_The_specified_file_was_not_found	g_locale_table[ 225 ].value
#define ST_V_The_specified_path_was_not_found			g_locale_table[ 226 ].value
#define ST_V_There_is_already_a_file					g_locale_table[ 227 ].value
#define ST_V_You_must_supply_download_directory			g_locale_table[ 228 ].value
...
#define ST_L_Proxy										g_locale_table[ 137 ].length
#define ST_L_Public___Private_key_pair_					g_locale_table[ 138 ].length
#define ST_L_Require_authentication_					g_locale_table[ 139 ].length
#define ST_L_Retry_incomplete_downloads_				g_locale_table[ 140 ].length
#define ST_L_Retry_incomplete_parts_					g_locale_table[ 141 ].length
#define ST_L_Server_SSL___TLS_version_					g_locale_table[ 142 ].length
#define ST_L_Set_date_and_time_of_file					g_locale_table[ 143 ].length
#define ST_L_Show_notification_when_downloads_finish	g_locale_table[ 144 ].length
#define ST_L_Thread_pool_count_							g_locale_table[ 145 ].length
#define ST_L_Timeout__seconds__							g_locale_table[ 146 ].length

// Add URL(s)
#define ST_L_Advanced_AB								g_locale_table[ 147 ].length
#define ST_L_Advanced_BB								g_locale_table[ 148 ].length
#define	ST_L_Authentication								g_locale_table[ 149 ].length
#define ST_L_Cookies_									g_locale_table[ 150 ].length
#define ST_L_Download									g_locale_table[ 151 ].length
#define ST_L_Download_directory_						g_locale_table[ 152 ].length
#define ST_L_Download_parts_							g_locale_table[ 153 ].length
#define ST_L_Headers_									g_locale_table[ 154 ].length
#define ST_L_Password_									g_locale_table[ 155 ].length
#define ST_L_Send_POST_Data_							g_locale_table[ 156 ].length
#define ST_L_Simulate_download							g_locale_table[ 157 ].length
#define ST_L_SSL___TLS_version_							g_locale_table[ 158 ].length
#define ST_L_URL_s__									g_locale_table[ 159 ].length
#define ST_L_Username_									g_locale_table[ 160 ].length

// Search
#define ST_L_Match_case									g_locale_table[ 161 ].length
#define ST_L_Match_whole_word							g_locale_table[ 162 ].length
#define ST_L_Search										g_locale_table[ 163 ].length
#define ST_L_Search_All									g_locale_table[ 164 ].length
#define ST_L_Search_for_								g_locale_table[ 165 ].length
#define ST_L_Search_Next								g_locale_table[ 166 ].length
#define ST_L_Search_Type								g_locale_table[ 167 ].length

// Common
#define ST_L_BTN___										g_locale_table[ 168 ].length
#define ST_L__Simulated_								g_locale_table[ 169 ].length
#define ST_L_Add_URL_s_									g_locale_table[ 170 ].length
#define ST_L_Added										g_locale_table[ 171 ].length
#define ST_L_All_downloads_have_finished_				g_locale_table[ 172 ].length
...
#define ST_L_Export_Download_History					g_locale_table[ 183 ].length
#define ST_L_Failed										g_locale_table[ 184 ].length
#define ST_L_File_IO_Error								g_locale_table[ 185 ].length
#define ST_L_Import_Download_History					g_locale_table[ 186 ].length
#define ST_L_Options									g_locale_table[ 187 ].length
#define ST_L_Paused										g_locale_table[ 188 ].length
#define ST_L_Proxy_Authentication_Required				g_locale_table[ 189 ].length
#define ST_L_Queued										g_locale_table[ 190 ].length
#define ST_L_Restarting									g_locale_table[ 191 ].length
#define ST_L_Save_Download_History						g_locale_table[ 192 ].length
#define ST_L_Skipped									g_locale_table[ 193 ].length
#define ST_L_Stopped									g_locale_table[ 194 ].length
#define ST_L_SSL_2_0									g_locale_table[ 195 ].length
#define ST_L_SSL_3_0									g_locale_table[ 196 ].length
#define ST_L_Timed_Out									g_locale_table[ 197 ].length
#define ST_L_TLS_1_0									g_locale_table[ 198 ].length
#define ST_L_TLS_1_1									g_locale_table[ 199 ].length
#define ST_L_TLS_1_2									g_locale_table[ 200 ].length
#define ST_L_Total_downloaded_							g_locale_table[ 201 ].length
#define ST_L_Total_downloaded__0_B						g_locale_table[ 202 ].length
#define ST_L_Total_downloaded__0_00_GB					g_locale_table[ 203 ].length
#define ST_L_Total_downloaded__0_00_KB					g_locale_table[ 204 ].length
#define ST_L_Total_downloaded__0_00_MB					g_locale_table[ 205 ].length
#define ST_L_URL_										g_locale_table[ 206 ].length
#define ST_L_Update										g_locale_table[ 207 ].length
#define ST_L_Update_Download							g_locale_table[ 208 ].length

// Common Messages
#define ST_L_A_restart_is_required						g_locale_table[ 209 ].length
#define ST_L_A_restart_is_required_allocation			g_locale_table[ 210 ].length
#define ST_L_A_restart_is_required_threads				g_locale_table[ 211 ].length
#define ST_L_PROMPT_delete_selected_files				g_locale_table[ 212 ].length
#define ST_L_PROMPT_remove_completed_entries			g_locale_table[ 213 ].length
#define ST_L_PROMPT_remove_and_delete_selected_entries	g_locale_table[ 214 ].length
#define ST_L_PROMPT_remove_selected_entries				g_locale_table[ 215 ].length
#define ST_L_PROMPT_restart_selected_entries			g_locale_table[ 216 ].length
#define ST_L_One_or_more_files_are_in_use				g_locale_table[ 217 ].length
#define ST_L_One_or_more_files_were_not_found			g_locale_table[ 218 ].length
#define ST_L_Select_the_default_download_directory		g_locale_table[ 219 ].length
#define ST_L_Select_the_download_directory				g_locale_table[ 220 ].length
#define ST_L_The_download_will_be_resumed				g_locale_table[ 221 ].length
#define ST_L_File_is_in_use_cannot_delete				g_locale_table[ 222 ].length
#define ST_L_File_is_in_use_cannot_rename				g_locale_table[ 223 ].length
#define ST_L_File_format_is_incorrect					g_locale_table[ 224 ].length
#define ST_L_PROMPT_The_specified_file_was_not_found	g_locale_table[ 225 ].length
#define ST_L_The_specified_path_was_not_found			g_locale_table[ 226 ].length
#define ST_L_There_is_already_a_file					g_locale_table[ 227 ].length
#define ST_L_You_must_supply_download_directory			g_locale_table[ 228 ].length
