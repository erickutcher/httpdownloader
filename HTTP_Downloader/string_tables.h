...
#define ST_Download_Directory		menu_string_table[ 16 ]
#define ST_Download_Speed			menu_string_table[ 17 ]
#define ST_Downloaded				menu_string_table[ 18 ]
#define ST_E_xit					menu_string_table[ 19 ]
#define ST_Exit						menu_string_table[ 20 ]
#define ST_File_Size				menu_string_table[ 21 ]
#define ST_File_Type				menu_string_table[ 22 ]
#define ST_Filename					menu_string_table[ 23 ]
#define ST_HTTP_Downloader__Home_Page	menu_string_table[ 24 ]
#define ST_Move_Down				menu_string_table[ 25 ]
#define ST_Move_To_Bottom			menu_string_table[ 26 ]
#define ST_Move_To_Top				menu_string_table[ 27 ]
#define ST_Move_Up					menu_string_table[ 28 ]
#define ST_Open_Directory			menu_string_table[ 29 ]
#define ST_Open_File				menu_string_table[ 30 ]
#define ST_Open_Download_List		menu_string_table[ 31 ]
#define ST_Options___				menu_string_table[ 32 ]
#define ST_Pause					menu_string_table[ 33 ]
#define ST_Pause_Active				menu_string_table[ 34 ]
#define ST_Progress					menu_string_table[ 35 ]
#define ST_Queue					menu_string_table[ 36 ]
#define ST_Remove_Completed			menu_string_table[ 37 ]
#define ST_Remove_Selected			menu_string_table[ 38 ]
#define ST_Select_All				menu_string_table[ 39 ]
#define ST_St_art					menu_string_table[ 40 ]
#define ST_Start					menu_string_table[ 41 ]
#define ST__Status_Bar				menu_string_table[ 42 ]
#define ST_St_op					menu_string_table[ 43 ]
#define ST_Stop						menu_string_table[ 44 ]
#define ST_Stop_All					menu_string_table[ 45 ]
#define ST_Time_Elapsed				menu_string_table[ 46 ]
#define ST_Time_Remaining			menu_string_table[ 47 ]
#define ST_TLS___SSL_Version		menu_string_table[ 48 ]
#define ST_Update_Download___		menu_string_table[ 49 ]
#define ST_URL						menu_string_table[ 50 ]
...
#define ST_Maximum_redirects_					options_string_table[ 27 ]
#define ST_Minimize_to_System_Tray				options_string_table[ 28 ]
#define ST_OK									options_string_table[ 29 ]
#define ST_PKCS_NUM12_							options_string_table[ 30 ]
#define ST_PKCS_NUM12_file_						options_string_table[ 31 ]
#define ST_PKCS_NUM12_password_					options_string_table[ 32 ]
#define ST_Port_								options_string_table[ 33 ]
#define ST_Proxy								options_string_table[ 34 ]
#define ST_Public___Private_key_pair_			options_string_table[ 35 ]
#define ST_Require_authentication_				options_string_table[ 36 ]
...
#define ST_URL_									common_string_table[ 32 ]
#define ST_Update								common_string_table[ 33 ]
#define ST_Update_Download						common_string_table[ 34 ]
...
#define ST_The_download_will_be_resumed				common_message_string_table[ 5 ]
#define ST_The_specified_file_was_not_found			common_message_string_table[ 6 ]
#define ST_The_specified_path_was_not_found			common_message_string_table[ 7 ]
#define ST_You_must_supply_download_directory		common_message_string_table[ 8 ]
