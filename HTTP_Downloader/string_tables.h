...
#define ST_Close_to_System_Tray					options_string_table[ 4 ]
#define ST_Configure_Proxies					options_string_table[ 5 ]
#define ST_Default_download_directory_			options_string_table[ 6 ]
#define ST_Default_download_parts_				options_string_table[ 7 ]
#define ST_Default_SSL___TLS_version_			options_string_table[ 8 ]
#define ST_Download								options_string_table[ 9 ]
#define ST_Enable_download_history				options_string_table[ 10 ]
#define ST_Enable_HTTP_proxy_					options_string_table[ 11 ]
#define ST_Enable_HTTPS_proxy_					options_string_table[ 12 ]
#define ST_Enable_quick_file_allocation			options_string_table[ 13 ]
#define ST_Enable_System_Tray_icon_				options_string_table[ 14 ]
#define ST_General								options_string_table[ 15 ]
#define ST_Hostname___IPv6_address_				options_string_table[ 16 ]
#define ST_IPv4_address_						options_string_table[ 17 ]
#define ST_Minimize_to_System_Tray				options_string_table[ 18 ]
#define ST_OK									options_string_table[ 19 ]
#define ST_Port_								options_string_table[ 20 ]
#define ST_Proxy								options_string_table[ 21 ]
#define ST_Retry_incomplete_downloads_			options_string_table[ 22 ]
#define ST_Retry_incomplete_parts_				options_string_table[ 23 ]
#define ST_Thread_pool_count_					options_string_table[ 24 ]
#define ST_Timeout__seconds__					options_string_table[ 25 ]

extern wchar_t *add_urls_string_table[];

#define ST_Add									add_urls_string_table[ 0 ]
#define ST_Advanced_AB							add_urls_string_table[ 1 ]
#define ST_Advanced_BB							add_urls_string_table[ 2 ]
#define	ST_Authentication						add_urls_string_table[ 3 ]
#define ST_Cookies_								add_urls_string_table[ 4 ]
#define ST_Download_directory_					add_urls_string_table[ 5 ]
#define ST_Download_parts_						add_urls_string_table[ 6 ]
#define ST_Password_							add_urls_string_table[ 7 ]
#define ST_Simulate_download					add_urls_string_table[ 8 ]
#define ST_SSL___TLS_version_					add_urls_string_table[ 9 ]
#define ST_URL_s__								add_urls_string_table[ 10 ]
#define ST_Use_HEAD_request						add_urls_string_table[ 11 ]
#define ST_Use_Keep_Alive						add_urls_string_table[ 12 ]
#define ST_Username_							add_urls_string_table[ 13 ]
