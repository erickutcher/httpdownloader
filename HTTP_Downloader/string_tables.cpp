...
wchar_t *menu_string_table[] =
{
	...
	L"E&xit",
	L"Exit",
	L"&Export Download History...",
	L"File Size",
	L"File Type",
	L"Filename",
	L"HTTP Downloader &Home Page",
	L"&Import Download History...",
	L"Move Down",
	L"Move To Bottom",
	L"Move To Top",
	L"Move Up",
...
wchar_t *options_string_table[] =
{
	...
	L"Allow only one instance of the program to run",
	L"Always on top",
	L"Apply",
...
wchar_t *common_message_string_table[] =
{
	...
	L"Are you sure you want to delete the selected files?",
	L"Are you sure you want to remove the completed entries?",
	L"Are you sure you want to remove the selected entries?",
	L"One or more files are in use and cannot be deleted.",
	L"One or more files were not found.",
	L"Select the default download directory.",
	L"Select the download directory.",
	L"The download will be resumed after it's updated.",
	L"The file is currently in use and cannot be deleted.",
	...
	L"There is already a file with the same name in this location.",
